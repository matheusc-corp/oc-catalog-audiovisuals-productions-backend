    ...
    public partial class NewTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductionsGenres", x => new { x.ProductionId, x.GenreId });
                    table.ForeignKey(
                        name: "FK_ProductionsGenres_Genres_GenreId",
                        column: x => x.GenreId,
                        principalTable: "Genres",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductionsGenres_Productions_ProductionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionsGenres_GenreId",
                table: "ProductionsGenres",
                column: "GenreId");
        }
